...
\item Q.~McNemar (1947). ``Note on the sampling error of the difference between correlated proportions.'' \textit{Psychometrika}, vol.~12, n.º~2, pp.~153--157. (Prueba de significancia pareada.)
...
\item R.~Pardo (2008). \textit{The Evaluation and Optimization of Trading Strategies}, 2.ª ed. Wiley. (Rango profesional de \textit{profit factor}.)
