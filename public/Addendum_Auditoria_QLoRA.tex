...
%
% *** OBSOLETO — contenido fusionado en Conclusions_Avance6.tex (2026-06-17) ***
%
% El contenido de este fragmento (ablación del filtro de drawdown + chequeo
% de memorización por pre-entrenamiento) fue integrado directamente en la
% sección "Discusión de resultados" → "Validación de robustez" del documento
% principal. Este archivo se conserva como referencia histórica pero NO debe
% ser \input{}-eado ni citado.
% ══════════════════════════════════════════════════════════════════════════════
