...
def run_edge_case_test():
    ...
    try:
        ...
        trade_res = binance_service.create_smart_trade(
            ...
            take_profit_price=price * 1.05, stop_loss_price=0, side="BUY"
        )
        ...
        close_res = binance_service.market_close_position(
            symbol=symbol, quantity=qty, client_order_id=tid 
        )
        ...
        binance_service.create_smart_trade(
            symbol=reconcile_symbol, quantity=qty_eth, buy_price=None,
            take_profit_price=price_eth * 1.05, stop_loss_price=0, side="BUY"
        )
        all_meta = trade_tracker._load_trades()
        ...
        print(f"🛠  Simulating manual Market Sell for ETH...")
