...
from app.models import CancelOrderRequest, MarketCloseRequest, SmartTradeRequest

# Local imports
from app.services import audit_service, binance_service
...
def market_close(req: MarketCloseRequest):
    return binance_service.market_close_position(
        symbol=req.symbol, quantity=req.quantity, order_list_id=req.orderListId
    )
